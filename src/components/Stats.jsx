...
const Stats = () => {
  return (
    <div className="flex gap-2 flex-row flex-wrap">
      <StatInfo info={"Total orders"} number={"75 ▲3%"} bg={"bg-blue-400"}>
        <Button className="bg-blue-600 hover:bg-blue-600" >
          <BsFillCartPlusFill size={25}/>
        </Button>
      </StatInfo>

      <StatInfo info={"Total delivered"} number={"70 ▼3%"} bg={"bg-green-300"}>
        <Button className="bg-green-400 hover:bg-green-400" >
          <BsCartCheckFill size={25} />
        </Button>
      </StatInfo>

      <StatInfo info={"Total Cancelled"} number={"5 ▲3%"} bg={"bg-red-400"}>
        <Button className="bg-red-500 hover:bg-red-500" >
          <BsFillCartXFill size={25} />
        </Button>
      </StatInfo>

      <StatInfo info={"Total Profit"} number={"5 ▲3%"} bg={"bg-pink-300"}>
